...
For our second try we were allowed to take inspiration from the winning grouo, Group 3. We stacked stuff on top of each oth by cutting the envelope into two rolled up cylinders anf taped them together. We would've won if it was stable.
